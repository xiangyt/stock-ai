...
func NewRiskParityAllocator() *RiskParityAllocator { return &RiskParityAllocator{} }
func (r *RiskParityAllocator) Name() string { return "risk_parity" }

func (r *RiskParityAllocator) Allocate(req *types.AllocRequest) *types.AllocResult {
...
func init() {
	types.RegisterAllocator("risk_parity", func(_ json.RawMessage) (types.Allocator, error) {
		return NewRiskParityAllocator(), nil
	})
}
